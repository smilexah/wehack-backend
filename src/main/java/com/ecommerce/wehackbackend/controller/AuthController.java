...
public class AuthController {
    ...
    public ResponseEntity<AuthResponseDto> verifyCode(@RequestBody VerifyCodeRequestDto requestDto) {
        AuthResponseDto response = authService.verifyCode(requestDto);
